    ...
    const showAlert = async (type: number) => {
        if (type === 1) {
            ...
            Swal.fire({
                ...
                imageUrl: GetProdDevImgRouteBuilder('/assets/images/custom-swal.svg'),
                imageWidth: 224,
                imageHeight: 'auto',
            ...
            Swal.fire({
                ...
                background: `#fff url(${GetProdDevImgRouteBuilder('/assets/images/sweet-bg.jpg')} no-repeat 100% 100%`,
            });
        } else if (type === 13) {
            Swal.fire({
                icon: 'error',
