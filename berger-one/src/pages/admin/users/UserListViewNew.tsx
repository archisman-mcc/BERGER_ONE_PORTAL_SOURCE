...
import { MantineReactTable, useMantineReactTable, type MRT_ColumnDef, type MRT_ColumnFilterFnsState, type MRT_ColumnFiltersState, type MRT_PaginationState, type MRT_SortingState } from 'mantine-react-table';
...
const UserListViewNew = () => {
    ...
    const table = useMantineReactTable({
        ...
        renderRowActionMenuItems: (row: any) => (
            <>
                <Menu.Item icon={<FaRegUserCircle />} onClick={() => selectUser(row.row.original)}>
                    View Profile
                </Menu.Item>
            </>
        ),
...
export default UserListViewNew