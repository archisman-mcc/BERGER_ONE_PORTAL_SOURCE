...
import { GetCustNotVisitedReport } from '../../../services/api/protectonReport/ProtectonReport';
...
const CustNotVisitedReport: React.FC = () => {
    ...
    const downloadTemplate = async () => {
        ...
        try {
            const response: any = await GetCustNotVisitedReport(payloadObj);
...
export default CustNotVisitedReport;