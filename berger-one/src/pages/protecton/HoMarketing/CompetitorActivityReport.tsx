...
import { GetCompetitorActivityReport } from '../../../services/api/protectonReport/ProtectonReport';
import { commonErrorToast } from '../../../services/functions/commonToast';
import { MantineReactTable, useMantineReactTable, type MRT_ColumnDef } from 'mantine-react-table';


const CompetitorActivityReport: React.FC = () => {
    ...
    const columns = useMemo<MRT_ColumnDef<any>[]>(
        () => [
            ...
            {
                accessorKey: 'competition_rate_ltr',
                header: 'Competition Rate/ Ltr',
                size: 120,
            },
            {
                accessorKey: 'technical_data_of_product_detail',
                header: 'Technical data of product detail',
                size: 120,
            },
            {
                accessorKey: 'order_value_lost_lks',
                header: 'Order Value lost (LKS)',
                size: 120,
            },
        ],
        []
...
export default CompetitorActivityReport;