    ...
    const handleSubmit = async () => {
        ...
        const payloadData = {
            potentialTrackingMstr: [{
                ...
                ptm_key_account_id: data.ptm_key_account_id?.value || 0,
                ...
                ptm_potential_val: data.ptm_potential_val || 0,
                ptm_potential_vol: data.ptm_potential_vol || 0,
                ptm_potential_area: data.ptm_potential_area || 0,
                ...
                ptm_product_category: data.ptm_product_category.length > 0 ? data.ptm_product_category?.map((ppc: any) => ppc?.value).join(",") : '',
