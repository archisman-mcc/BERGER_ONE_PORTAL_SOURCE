...
const TLVRevisionDepotApproval = () => {
    ...
    const GetTlvDepotApprovalListData = async () => {
        ...
        const data: any = {
            ...
            aprvStatus: selectedDropdown.UsersubStatus != -1 ? approveStatus[selectedDropdown.UsersubStatus].lov_code : 'PENDING_DEPOT',
        };
        try {
...
export default TLVRevisionDepotApproval;
