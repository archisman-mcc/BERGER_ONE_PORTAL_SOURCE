...
const TLVRevisionRSMApproval = () => {
        ...
        try {
            ...
            if (!currentUsersubStatusExists) {
                setSelectedDropdown((prev) => ({
                    ...prev,
                    UsersubStatus: 0, // or set it to any default value you prefer
                }));
            }
        } catch (error) {
            return;
    ...
    const GetTlcRsmApprovalListData = async () => {
        ...
        const data: any = {
            ...
            aprvStatus: selectedDropdown.UsersubStatus != -1 ? approveStatus[selectedDropdown.UsersubStatus].lov_code : 'PENDING_RSM',
        };
        try {
...
export default TLVRevisionRSMApproval;
