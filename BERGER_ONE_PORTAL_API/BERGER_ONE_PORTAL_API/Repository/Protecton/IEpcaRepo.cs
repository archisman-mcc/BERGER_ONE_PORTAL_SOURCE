...
namespace BERGER_ONE_PORTAL_API.Repository.Protecton
{
    public interface IEpcaRepo
    {
        ...
        Task<MSSQLResponse?> GetCalculatedGC(GetCalculatedGCRequestDto request, string user_id);
        ...
        Task<MSSQLResponse> TlvDetailsSubmit(TlvDetailsSubmitRequestDto requestDto);
